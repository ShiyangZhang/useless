...
nodes_file=fopen("C:\\Users\\zhang\\Desktop\\easymesh\\G6.n","r");
...
int num_sides;
sides_file=fopen("C:\\Users\\zhang\\Desktop\\easymesh\\G6.s","r");
if(NULL==sides_file)                                                                       
  {                                                                             
...
elements_file=fopen("C:\\Users\\zhang\\Desktop\\easymesh\\G6.e","r");
  ...
  for(s=0;s<3;s++)
      ...
      {if(localength[s]>=0)
		  {i=sides[abs(eptr[s])-1].ptr-1;
	          ...
	          gg[i]+= delta*sign(eptr[s])*(( 2 )  *(aaa[s]*invM[0][(1+s)%3]-aaa[(1+s)%3]*invM[0][s]+y0*(invM[1][s]*invM[0][(1+s)%3]-invM[1][(1+s)%3]*invM[0][s]))	+
              2     * (aaa[s]*invM[1][(1+s)%3]-aaa[(1+s)%3]*invM[1][s]-x0*(invM[1][s]*invM[0][(1+s)%3]-invM[1][(1+s)%3]*invM[0][s])	)   );
           }
     }
